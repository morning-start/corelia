...
/// # Safety
///
/// 包含 rquickjs::Runtime 和 rquickjs::Context，它们原本是 !Send + !Sync。
/// VmCore 始终通过 QuickJSRuntime 的 Mutex<Vec<VmCore>> 访问，Mutex 保证：
