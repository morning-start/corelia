...
| 任务 | 状态 | 优先级 | 影响 | 关联文件 |
|------|:----:|:------:|:----:|----------|
| QuickJS `unsafe impl Send/Sync` 移除（当前6处：quickjs_runtime.rs 4处 + loader.rs 2处） | ⬜ | P0 | 安全性↑↑ | [`quickjs_runtime.rs`](src-tauri/src/plugins/quickjs_runtime.rs), [`loader.rs`](src-tauri/src/plugins/loader.rs) |
