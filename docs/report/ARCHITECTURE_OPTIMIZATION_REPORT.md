...
> ⚠️ **阶段性快照（已归档）** — 本文档生成于 2026-04-29，是 MVP 核心框架阶段的架构分析快照。此后代码已有大量迭代：
> - `api_bridge.rs` 已拆分为 15 个子模块 ✅
> - `loader.rs` 已拆分为 7 个子模块 ✅
> - 搜索 Store 已解耦（system/plugin/merger）✅
> - Store 已迁移至 Svelte 5 Runes ✅
> - QuickJS `unsafe impl` 已从 6 处降至 2 处 ✅
> - 插件崩溃隔离与自动恢复已实现 ✅
>
> 本文档不再更新，保留作为历史参考和优化思路记录。
>
> **当前开发状态见 [TODO.md](../TODO.md)** | **最新架构文档见 [wiki/ARCHITECTURE.md](../wiki/ARCHITECTURE.md)**
